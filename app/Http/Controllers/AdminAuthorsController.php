<?php namespace App\Http\Controllers;
	...
	class AdminAuthorsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Url Institution","name"=>"url_institution"];
			$this->col[] = ["label"=>"Url Academia","name"=>"url_academia"];
			...
			$this->form[] = ['label'=>'Url Institution','name'=>'url_institution','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Url Academia','name'=>'url_academia','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Url Institution","name"=>"url_institution","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Url Academia","name"=>"url_academia","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
