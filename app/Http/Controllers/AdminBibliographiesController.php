<?php namespace App\Http\Controllers;
	...
	class AdminBibliographiesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Short Title","name"=>"short_title"];
			...
			$this->col[] = ["label"=>"Bibliography Types Id","name"=>"bibliography_types_id","join"=>"bibliography_types,name"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Short Title','name'=>'short_title','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Pages','name'=>'pages','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Author','name'=>'author','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Volume Nr','name'=>'volume_nr','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Bibliography Types Id','name'=>'bibliography_types_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'bibliography_types,name'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Short Title","name"=>"short_title","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Bibliography Types Id","name"=>"bibliography_types_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"bibliography_types,name"];
			# OLD END FORM
